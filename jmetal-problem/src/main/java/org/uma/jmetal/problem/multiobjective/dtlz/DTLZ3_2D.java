...
public class DTLZ3_2D extends AbstractDoubleProblem {
  /**
   * Creates a default DTLZ3 problem (12 variables and 3 objectives)
   */
  public DTLZ3_2D() throws ClassNotFoundException, JMetalException {
    this(12, 2);
  }
   ...
   */
  public DTLZ3_2D(Integer numberOfVariables, Integer numberOfObjectives) throws JMetalException {
