 ...
 */
public class RankingAndNewCrowdingDistanceComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
  private final Comparator<S> rankComparator = new RankingComparator<S>();
  private final Comparator<S> HypervolumeContributionComparator = new HypervolumeContributionComparator<S>() ;
  ...
  public int compare(S solution1, S solution2) {
    ...
    if (result == 0) {
      result = HypervolumeContributionComparator.compare(solution1, solution2);
    }
